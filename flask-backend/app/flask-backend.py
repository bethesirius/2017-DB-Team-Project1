...
manager.create_api(AssetModel, methods=METHODS)
manager.create_api(StorageSpecNameModel, methods=METHODS)
manager.create_api(StorageSpecTypeModel, methods=METHODS)
manager.create_api(StorageSpecModel, methods=METHODS)
manager.create_api(RackSpecModel, methods=METHODS)
manager.create_api(ServerSpecModel, methods=METHODS)
manager.create_api(SwitchSpecModel, methods=METHODS)
manager.create_api(DeviceModel, methods=METHODS)
manager.create_api(RackModel, methods=METHODS)
manager.create_api(ServerModel, methods=METHODS)
manager.create_api(StorageModel, methods=METHODS)
manager.create_api(SwitchModel, methods=METHODS)
manager.create_api(LocationModel, methods=METHODS)
manager.create_api(DetailLocationModel, methods=METHODS)
manager.create_api(AssetNameModel, methods=METHODS)
manager.create_api(BuyModel, methods=METHODS)
manager.create_api(StandardModel, methods=METHODS)
manager.create_api(DeviceInfoForServerModel, methods=METHODS)
manager.create_api(DeviceInfoForSwitchModel, methods=METHODS)
manager.create_api(DeviceInfo, methods=METHODS)
manager.create_api(RackLocationForServerModel, methods=METHODS)
manager.create_api(RackLocationForSwitchModel, methods=METHODS)
