...
import { Header, Confirm, Icon, Dropdown, Modal } from 'semantic-ui-react'
    ...
    render(){
        const content=(
            <Modal.Content>
                ...
                <span>
                    Mount Lv:
                    <Dropdown options={this.state.valid_lv} disabled={!this.state.selected_asset.value} selection fluid/>
                </span>
            </Modal.Content>
        );
